...
std::unique_ptr<Number> IntegerNumber::get_absolute_value(Number& other) const {
...
std::unique_ptr<Number> IntegerNumber::converting_natural_to_integer(Number& other) const {
